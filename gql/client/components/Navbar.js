        ...
        <ul className="navbar-nav">
          <li className="logo">
            <a href="#" target="" className="nav-link">
              <span className="link-text logo-text">DASHBOARD</span>
              <svg
                aria-hidden="true" 
                focusable="false"
                data-prefix="fad"
          ...
          <li className="nav-item">
            <a href="Home" className="nav-link">
              ...
              <span className="link-text">STARTUPS</span>
            </a>
          </li>
          ...
          <li className="nav-item">
            <a href="addStartup" className="nav-link">
              ...
              <span className="link-text">ADICIONAR</span>
            </a>
          </li>
          ...
          <li className="nav-item" id="themeButton">
            <a href="#" className="nav-link">
              ...
              <span className="link-text">POWERED BY:FIRESHIP</span>
            </a>
          </li>
        </ul>
      </nav>
